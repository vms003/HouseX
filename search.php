   ...
   <form action="" method="post">
      <h3>filter your search</h3>
         <div class="flex">
            <div class="box">
               <p>Enter Location</p>
               <input type="text" name="location" required maxlength="50" placeholder="Enter City" class="input">
            </div>
            <div class="box">
               <p>Offer Type</p>
            ...
            <div class="box">
         <p>Minimum Budget</p>
         <input type="number" name="min_budget" class="input" required>
      </div>
      <div class="box">
         <p>Maximum Budget</p>
         <input type="number" name="max_budget" class="input" required>
      </div>
            <div class="box">
               <p>status</p>
...
if(isset($_POST['filter_search'])){
   ...
   $min_budget = isset($_POST['min_budget']) ? $_POST['min_budget'] : '';
   $max_budget = isset($_POST['max_budget']) ? $_POST['max_budget'] : '';
   $select_properties = $conn->prepare("SELECT * FROM `property` WHERE address LIKE '%{$location}%' AND type LIKE '%{$type}%' AND offer LIKE '%{$offer}%' AND bhk LIKE '%{$bhk}%' AND status LIKE '%{$status}%' AND furnished LIKE '%{$furnished}%' AND price BETWEEN $min_budget AND $max_budget ORDER BY date DESC");
